...
import { FileText, Sparkles, CheckCircle2, AlertCircle, ChevronRight } from 'lucide-react';
        ...
        <Card variant="elevated" className="animate-slide-up">
            <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Badge variant="outline" className="font-normal">
                    {filledRequired} / {requiredFieldsCount} 필수항목
                </Badge>
            </CardHeader>
            <CardContent className="space-y-5">
                ...
                <div className="pt-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 text-sm">
                        {filledRequired >= requiredFieldsCount ? (
                            <>
                            ...
                            <>
                                ...
                                <span className="text-muted-foreground">
                                    {requiredFieldsCount - filledRequired}개 필수 항목이
                                    남았습니다
                                </span>
                            </>
                        )}
                    ...
                    <Button
                        className="gap-2"
                        disabled={filledRequired < requiredFieldsCount}
