...
const mainNavItems: NavItem[] = [
  ...
  { icon: Upload, label: "문서 업로드", href: "/upload" },
];
        ...
        <div className="flex items-center gap-3">
          ...
          {!isCollapsed && (
            <div className="flex flex-col">
              <span className="font-bold text-sidebar-foreground text-sm">스마트 공고문</span>
              <span className="text-xs text-sidebar-foreground/60">어시스턴트</span>
            </div>
          )}
        </div>
      </div>
